...
export default function Sidebar() {
  return (
    <aside className="fixed left-0 top-0 h-screen w-14 bg-white border-r border-neutral-200 flex flex-col items-center py-0 gap-0">
      {/* Logo Header - Green Background */}
      <div className="w-14 h-14 bg-brand-primary rounded-none flex items-center justify-center font-bold text-white text-lg">
      ...
      <div className="w-full flex flex-col items-center gap-0">
        ...
        <button
          aria-label="Settings"
          className="w-14 h-14 hover:bg-neutral-100 transition-colors flex items-center justify-center text-neutral-600 hover:text-brand-primary border-t border-neutral-200"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* User initial */}
        <div className="w-14 h-10 flex items-center justify-center text-neutral-600 text-xs font-semibold">
          ku
        </div>
      </div>
    </aside>
